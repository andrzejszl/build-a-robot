<template>
  <div>
    <div class="top-row">
      <div class="top part">
        <img :src="availableParts.heads[selectedHeadIndex].src" title="head" alt="head big eye"/>
    ...
    <div class="bottom-row">
      <div class="bottom part">
        ...
        title="left arm" alt="base single wheel"/>
